...
- 用户实际操作说明：第三胜单场成绩页点“返回大厅”→挑战概览右上“完成”→确认页右下“完成”→每日挑战巴掌进度页→点空白继续→可能出现额外奖励页→继续→擂台排名页。前三胜成绩页/返回大厅按钮源图、额外奖励图8、最终排名页未在本批附件中；本批实际只有7张。
...
- 当前仍只读规划，不启动设备、不点击完成/退出/开赛。若需现场资料，优先建议补图8与带返回大厅按钮的第三胜成绩页，不要求重跑D配置或整套全流程。
必读：
